...
*	Author:		Ben Johnston
*	Name:		Demo03.IndirectAttack.04.Compiled.Parameters.sql
*	Notes:		Compiled parameters can expose sensitive data that would
*				normally be protected by masking or RLS.
...
SELECT
	OBJECT_SCHEMA_NAME(est.objectid,est.dbid) SchemaName
	,OBJECT_NAME(est.objectid,est.dbid) ObjectName
